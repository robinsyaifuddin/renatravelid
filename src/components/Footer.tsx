      ...
      <div className="container mx-auto px-2 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            {/* Logo */}
            <div className="mb-6">
              <img src="/lovable-uploads/b601ee98-9814-4475-9547-1043c24ddbbe.png" alt="Renatravel.id Logo" className="h-12 w-auto object-contain" />
            </div>
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/renatravel.id" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center hover:bg-pink-600 hover:text-white active:bg-pink-700 transition-all duration-200 transform hover:scale-110">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="https://www.tiktok.com/@rena_travel" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center hover:bg-black hover:text-white active:bg-gray-800 transition-all duration-200 transform hover:scale-110">
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">Hak Cipta © 2025 renatravel.id. Semua Hak Dilindungi</div>
