          ...
          <div className="relative group order-2 lg:order-1">
            <div className="relative h-48 sm:h-64 md:h-80 lg:h-96 xl:h-[500px] rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute top-3 sm:top-4 left-3 sm:left-4 z-20">
                <Button
                  onClick={toggleVideo}
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/20 backdrop-blur-sm border-white/30 text-white hover:bg-white/30 transition-all duration-200"
                >
              ...
              {!showVideo && (
                <>
                  <Button 
                    ...
                    size="sm" 
                    onClick={prevImage} 
                    className="absolute left-2 sm:left-3 md:left-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-white/20 backdrop-blur-sm border-white/30 text-white hover:bg-white/30 transition-all duration-200 z-20"
                  >
                  ...
                  <Button 
                    ...
                    size="sm" 
                    onClick={nextImage} 
                    className="absolute right-2 sm:right-3 md:right-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-white/20 backdrop-blur-sm border-white/30 text-white hover:bg-white/30 transition-all duration-200 z-20"
                  >
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
                    <Button 
                      ...
                      className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full bg-white/20 backdrop-blur-sm border-white/30 text-white hover:bg-white/30 transition-all duration-200"
                    >
          ...
          <div className="flex flex-col justify-center space-y-4 sm:space-y-6 md:space-y-8 order-1 lg:order-2 px-2 sm:px-0">
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4 mb-4 sm:mb-6">
                ...
                <div className="text-center p-3 md:p-4 bg-gray-50 rounded-lg">
                  <div className="text-lg sm:text-xl md:text-2xl font-bold text-emerald-600 mb-1">4.9★</div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex flex-col sm:flex-row gap-3">
                <Button 
                  ...
                  className="flex-1 sm:flex-none bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white px-4 sm:px-6 md:px-8 py-3 rounded-full font-semibold transition-all duration-200 shadow-lg hover:shadow-xl text-sm sm:text-base"
                >
                  Lihat Semua Destinasi
                </Button>
                
                <Button 
                  onClick={() => navigate(`/tour/${currentDestination.id}`)}
                  variant="outline" 
                  className="flex-1 sm:flex-none border-emerald-600 text-emerald-600 hover:bg-emerald-50 px-4 sm:px-6 md:px-8 py-3 rounded-full font-semibold transition-all duration-200 text-sm sm:text-base"
                >
