        ...
        <div className="flex justify-between items-center">
            ...
            {menuItems.map(item => {
              ...
              return (
                <Link
                  ...
                  className={`${
                    isActive(item.href)
                      ? 'text-emerald-600 bg-gradient-to-br from-emerald-50 to-teal-100 shadow-lg transform scale-105 border border-emerald-200/50'
                      : 'text-gray-700 hover:text-emerald-600 hover:bg-gradient-to-br hover:from-emerald-50/80 hover:to-teal-100/80 hover:shadow-md hover:scale-102 hover:border hover:border-emerald-200/30'
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2 lg:space-x-3">
            ...
            <Button
              variant="outline"
              size="sm"
              className="hidden sm:flex items-center border-emerald-200 text-emerald-600 hover:bg-gradient-to-br hover:from-emerald-50 hover:to-teal-100 hover:border-emerald-300 transition-all duration-300 hover:shadow-lg transform hover:scale-110 w-8 h-8 lg:w-9 lg:h-9 p-0 rounded-xl group"
            ...
            <Button
              variant="ghost"
              size="sm"
              className="lg:hidden touch-friendly text-gray-700 hover:text-emerald-600 hover:bg-gradient-to-br hover:from-emerald-50 hover:to-teal-100 transition-all duration-300 w-8 h-8 p-0 rounded-lg hover:shadow-md transform hover:scale-110 transform-gpu"
          ...
          <div className="lg:hidden mt-3 py-3 border-t border-gray-200 bg-gradient-to-br from-white/95 to-emerald-50/80 backdrop-blur-lg rounded-2xl shadow-2xl animate-fade-in transform-gpu border border-emerald-100/50"
            ...
            <nav className="space-y-0.5">
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center space-x-3 px-4 py-2.5 rounded-lg transition-all duration-300 font-medium transform hover:scale-102 ${
                      isActive(item.href)
                        ? 'text-emerald-600 bg-gradient-to-r from-emerald-50 to-teal-100 shadow-md border border-emerald-200/50'
                        : 'text-gray-700 hover:text-emerald-600 hover:bg-gradient-to-r hover:from-emerald-50/70 hover:to-teal-100/70 hover:shadow-sm'
                    }`}
              ...
              <div className="px-4 pt-2 mt-1">
                <Button
                  className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-medium py-2.5 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-102 flex items-center justify-center space-x-2 border border-emerald-400/20"
                  onClick={() => {
                    handleConsultation();
                    setIsMobileMenuOpen(false);
                  }}
